...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:mods="http://www.loc.gov/mods/v3"
	xmlns:pica="info:srw/schema/5/picaXML-v1.0" xmlns:mets="http://www.loc.gov/METS/"
	xmlns:wdb="http://diglib.hab.de/wdb/" xmlns:rmd="http://diglib.hab.de/rights" xmlns:tei="http://www.tei-c.org/ns/1.0"
	xmlns:html="http://www.w3.org/1999/xhtml" xmlns:xlink="http://www.w3.org/1999/xlink" version="2.0"
				...
				<xsl:when test="/mets:mets/mets:dmdSec[@ID = 'dmd_local']">
					<div id="toc_title">
						<div>
							<xsl:choose>
								<xsl:when test="/mets:mets/mets:dmdSec[@ID = 'dmd_local']/mets:mdWrap/mets:xmlData/mods:mods">
									<xsl:apply-templates
										select="//mets:mets/mets:dmdSec[@ID = 'dmd_local']/mets:mdWrap/mets:xmlData/mods:mods"/>
								</xsl:when>
								<!-- TEI lokal -->
									...
									<xsl:if test="/mets:mets/mets:dmdSec[@ID = 'dmd_local']/mets:mdWrap/mets:xmlData/wdb:ppn">
										...
										<a>
											<xsl:attribute name="href">
												...
												<xsl:value-of
													select="/mets:mets/mets:dmdSec[@ID = 'dmd_local']/mets:mdWrap/mets:xmlData/wdb:ppn"/>
											</xsl:attribute>
						...
						<div style="font-size:smaller;margin:0.5em 0 0.5em 0;">
							<xsl:choose>
								<xsl:when
									test="/mets:mets/mets:dmdSec[@ID = 'dmd_local']/mets:mdWrap/mets:xmlData/mods:mods/mods:identifier[@type = 'purl']">
									<xsl:value-of
										select="/mets:mets/mets:dmdSec[@ID = 'dmd_local']/mets:mdWrap/mets:xmlData/mods:mods/mods:identifier[@type = 'purl']"
									/>
								</xsl:when>
								<!-- wdb deprecated  -->
	...
	<xsl:template match="mets:div">
		...
		<xsl:choose>
			...
			<xsl:when
				test="@TYPE = 'menu' or //mets:behavior[@ID = 'function_folding'][@STRUCTID = current()/@ID]/mets:mechanism[@xlink:actuate = 'onLoad']">
			...
			<xsl:when
				test="@TYPE = 'submenu' or //mets:behavior[@ID = 'function_folding'][@STRUCTID = current()/@ID]/mets:mechanism[@xlink:actuate = 'onRequest']">
				<li>
			...
			<xsl:when
				test="(//mets:file[@ID = current()/mets:fptr/@FILEID]/@MIMETYPE != 'application/xml') and (//mets:file[@ID = current()/mets:fptr/@FILEID]/@MIMETYPE != 'text/xml')">
				<li>
					<a>
						<xsl:attribute name="href">
						...
						<xsl:choose>
							<xsl:when
								test="//mets:behavior[@STRUCTID = current()/@ID]/mets:mechanism/@xlink:show = 'new' or //mets:file[@ID = current()/mets:fptr/@FILEID]/mets:FLocat/@xlink:show = 'new'">
								<xsl:attribute name="target">_blank</xsl:attribute>
							</xsl:when>
							<xsl:when
								test="//mets:behavior[@STRUCTID = current()/@ID]/mets:mechanism/@xlink:show = 'replace' or //mets:file[@ID = current()/mets:fptr/@FILEID]/mets:FLocat/@xlink:show = 'replace'">
			...
			<xsl:when
				test="(//mets:file[@ID = current()/mets:fptr/@FILEID]/@MIMETYPE = 'application/xml') or (//mets:file[@ID = current()/mets:fptr/@FILEID]/@MIMETYPE = 'text/xml')">
				<li>
					<a>
						<xsl:attribute name="href">
							<!-- angepaßt für WDB-eXist; 2016-07-19 DK -->
							...
							<xsl:value-of select="mets:fptr/@FILEID"/>
