...
import module namespace habm = "http://diglib.hab.de/ns/mets" at "modules/mets.xqm";
import module namespace hab = "http://diglib.hab.de/ns/hab" at "modules/app.xql";
...
let $xsl := doc('xmldb:exist:///db/edoc/resources/mets.xsl')
	...
	let $metsFile := concat($hab:edoc, '/', $id,"/mets.xml")
